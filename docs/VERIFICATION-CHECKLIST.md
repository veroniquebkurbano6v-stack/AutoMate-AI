...
- [ ] 仓库：https://github.com/veroniquebkurbano6v-stack/AutoMate-AI
...
- [ ] 安装 `AutoMate-AI-v1.0.apk`（不含任何 API Key），在 App「设置」页自行填写模型 Key
...
- [ ] `python eval/eval_retrieval.py` → 31/31 场景 100% 检索命中率（与 `docs/evaluation.md` 一致）
